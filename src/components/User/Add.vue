<template>
  <el-dialog title="编辑账号" :visible.sync="showFlag" custom-class="dialog-small" @close="closeDialog">
    <el-form ref="formData" :model="formData" :rules="formRules" label-width="80px">
      ...
      <el-form-item label="账号类型" prop="type">
        <el-select v-model="formData.type" class="select_sty">
